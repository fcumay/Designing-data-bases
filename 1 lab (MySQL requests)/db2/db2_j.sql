...
CREATE TABLE `j` (
  ...
  `Имя_PR` varchar(25) DEFAULT NULL,
...
INSERT INTO `j` VALUES ('ПР1','ИПР1','Минск'),('ПР2','ИПР2','Таллинн'),('ПР3','ИПР3','Псков'),('ПР4','ИПР4','Псков'),('ПР5','ИПР1','Москва'),('ПР6','ИПР1','Саратов'),('ПР7','ИПР1','Москва');
